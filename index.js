  ...
  const messages = [
    {
      role: "system",
      content:
        "You are a smart WhatsApp AI assistant. Remember context and reply naturally."
    },
    ...history,
  ...
  try {
    ...
    if (msg.type === "image") {
      try {
        ...
        // Simple safe reply (NO vision errors)
        const reply =
          "📸 I received your image successfully. Vision AI upgrade coming next step.";
